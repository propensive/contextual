...
Firstly, thank you for taking an interesting in contributing! Contextual is an open-source project, and welcomes
...
Contextual is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Contextual is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.contextual:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.contextual:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/contextual` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Contextual does not use automatic code-formatting
...
development environment for all Contextual&rsquo;s users. Propensive O&Uuml; reserves the right to censure
